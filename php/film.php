        ...
        <div class="container">
            <div class="card">
                ...
                <?php if (isset($_GET['msg']) && $_GET['msg'] === 'added'): ?>
                    <div class="alert alert-success">Film baru berhasil ditambahkan!</div>
                <?php endif; ?>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <?php if (!empty($daftar_film)): ?>
                                <?php $no = 1; foreach ($daftar_film as $film): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="7" style="text-align:center;color:#95a5a6;padding:30px;">Belum ada data film di database.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
